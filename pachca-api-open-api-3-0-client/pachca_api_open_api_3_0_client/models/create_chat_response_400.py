...
T = TypeVar("T", bound="CreateChatResponse400")


@_attrs_define
class CreateChatResponse400:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_chat_response_400 = cls(
            errors=errors,
        )

        create_chat_response_400.additional_properties = d
        return create_chat_response_400
