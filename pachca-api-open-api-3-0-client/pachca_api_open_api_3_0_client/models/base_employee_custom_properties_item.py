...
T = TypeVar("T", bound="BaseEmployeeCustomPropertiesItem")


@_attrs_define
class BaseEmployeeCustomPropertiesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        base_employee_custom_properties_item = cls(
            id=id,
            name=name,
            data_type=data_type,
            value=value,
        ...
        base_employee_custom_properties_item.additional_properties = d
