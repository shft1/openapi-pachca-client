...
T = TypeVar("T", bound="CreateChatResponse404")


@_attrs_define
class CreateChatResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_chat_response_404 = cls(
            errors=errors,
        )

        create_chat_response_404.additional_properties = d
        return create_chat_response_404
