...
T = TypeVar("T", bound="GetChatResponse404")


@_attrs_define
class GetChatResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_chat_response_404 = cls(
            errors=errors,
        )

        get_chat_response_404.additional_properties = d
        return get_chat_response_404
