...
T = TypeVar("T", bound="CreateChatResponse422")


@_attrs_define
class CreateChatResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_chat_response_422 = cls(
            errors=errors,
        )

        create_chat_response_422.additional_properties = d
        return create_chat_response_422
