...
T = TypeVar("T", bound="PutStatusResponse201")


@_attrs_define
class PutStatusResponse201:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_status_response_201 = cls(
            data=data,
        )

        put_status_response_201.additional_properties = d
        return put_status_response_201
